...
parser.add_argument('--test', type=bool, default=True, help='test the model if trained before.')
...
parser.add_argument('--image', type=str, default='test1.PNG', help='image to classify')
...
class Classifier:
	...
	def __init__(self, window_size, whether_client, workers,verbose, grid_search, model_path):
		...
		self.resize_shape=200#200/300 #reshape all images into (200,200)
