...
# 模型权重路径
DERAIN_MODEL_PATH = './DID-MDN/netG_epoch_9_main.pth'
LABEL_MODEL_PATH = './DID-MDN/classification/netG_epoch_9.pth'
RESIDUAL_MODEL_PATH = './DID-MDN/residual_heavy/netG_epoch_6.pth'
...
for i, data in enumerate(val_loader):
    ...
    with torch.no_grad():
        ...
        if num == 3:
            ...
            os.system(f"cp '{image_path[0]}' '{nlcl_path}'")
        else:
            # # 3. 去雨推理
